...
local hubLoader = 'loadstring(game:HttpGet("https://pastefy.app/TNa3LYIt/raw"))()'
...
local function showQBreachingCover()
    ...
    bg.BackgroundColor3 = Color3.fromRGB(50, 10, 10) -- deep red
    bg.BackgroundTransparency = 0.11

    -- Centered glassy card with red shadow
    ...
    shadow.ImageColor3 = Color3.fromRGB(255, 60, 60) -- bright red
    ...
    frame.BackgroundColor3 = Color3.fromRGB(90, 22, 22) -- dark red
    ...
    ring.ImageColor3 = Color3.fromRGB(255, 100, 100) -- light red
    ...
    qCircle.BackgroundColor3 = Color3.fromRGB(255, 140, 140) -- pale red
    ...
    qTail.BackgroundColor3 = Color3.fromRGB(255, 140, 140) -- pale red
    ...
    for i=1,10 do
        ...
        rain.TextColor3 = Color3.fromRGB(255, 100, 100) -- light red
    ...
    status.TextColor3 = Color3.fromRGB(255, 220, 220) -- white-pink
    ...
    substatus.TextColor3 = Color3.fromRGB(255, 140, 140) -- pink-red
    ...
    progressBarBg.BackgroundColor3 = Color3.fromRGB(120, 20, 30) -- dark red
    ...
    progressBar.BackgroundColor3 = Color3.fromRGB(255, 60, 60) -- bright red
    ...
    brand.Text = "Q"
    brand.TextColor3 = Color3.fromRGB(255, 140, 140) -- light red
    ...
    coroutine.wrap(function()
        ...
        while running and gui.Parent do
            ...
            local color = Color3.fromHSV(hue, 0.64, 1) -- more red/pink
...
pcall(function()
    loadstring(game:HttpGet("https://pastefy.app/TNa3LYIt/raw"))()
end)
