...
icon.Image = "rbxassetid://113350922301255" -- Your logo asset ID
...
subText.Text = "discord.gg/DaveHubScript"
...
spawnButton.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        local success, result = pcall(function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/exploiter101/deobfuscatethis/refs/heads/main/random.lua"))()
        end)
    end)
